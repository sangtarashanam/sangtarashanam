...
function ContactUs (){
    return (
        <>
<section  className="bg-white w-full p-20 overflow-hidden relative z-10">
            ...
            <div  className="max-w-[570px] mb-12 lg:mb-0">
               ...
               <div  className="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div  className="w-full">
                     ...
                     <p  className="text-base text-body-color"> 583 593 7 0912</p>
                  </div>
               </div>
               <div  className="flex mb-8 max-w-[370px] w-full">
                  <div
                  ...
                  <div  className="w-full">
                     ...
                     <p  className="text-base text-body-color">sangtarashanam@gmail.com</p>
                  </div>
               </div>
            </div>
         </div>
