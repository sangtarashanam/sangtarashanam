  ...
  return (
    <div>
      ...
      <Swiper
        ...
        speed={600}
        breakpoints={{
          1280: { slidesPerView: 4, spaceBetween: 35, slidesPerGroup: 5 },
          1024: { slidesPerView: 3, spaceBetween: 20, slidesPerGroup: 4 },
          768: { slidesPerView: 2, spaceBetween: 16, slidesPerGroup: 2 },
          640: { slidesPerView: 1, spaceBetween: 12, slidesPerGroup: 2 },
        }}
      >
        {newData.map((item) => {
          return (
